...
function getDefaultConfig() {
  return {
    ...
    marketFactory: function (symbolObj) {
      // console.log(symbolObj);
      if (symbolObj.exchDisp === "NSE" || symbolObj.exchDisp === "BSE" || symbolObj.exchDisp === "NFO" || symbolObj.exchDisp === "BFO") {
        return {
          name: symbolObj.exchDisp,
          market_tz: "Asia/Kolkata",
          hour_aligned: true,
          beginningDayOfWeek: 0,
          normal_daily_open: "09:15",
          normal_daily_close: "15:30",
          rules: [
              {"date": "2021-02-24", "open": "9:15", "close": "17:00" },
              {"date": "2021-11-04", "open": "18:15", "close": "19:15" },
              {"dayofweek": 1, "open": "09:15", "close": "15:30"},
              {"dayofweek": 2, "open": "09:15", "close": "15:30"},
              {"dayofweek": 3, "open": "09:15", "close": "15:30"},
              {"dayofweek": 4, "open": "09:15", "close": "15:30"},
              {"dayofweek": 5, "open": "09:15", "close": "15:30"},
          ]
        }
      }
      if (symbolObj.exchDisp === "CDS") {
        return {
          name: symbolObj.exchDisp,
          market_tz: "Asia/Kolkata",
          hour_aligned: true,
      ...
      if (symbolObj.exchDisp === "MCX") {
        return {
          ...
          beginningDayOfWeek: 0,
          normal_daily_open: "09:00",
          normal_daily_close: "23:30",
          rules: [
              {"date": "2021-11-04", "open": "18:15", "close": "19:15" },
              {"dayofweek": 1, "open": "09:00", "close": "23:55"},
              {"dayofweek": 2, "open": "09:00", "close": "23:55"},
              {"dayofweek": 3, "open": "09:00", "close": "23:55"},
              {"dayofweek": 4, "open": "09:00", "close": "23:55"},
              {"dayofweek": 5, "open": "09:00", "close": "23:55"},
          ]
        }
      } 
      return null;
    ...
    quoteFeeds: [
      {
        quoteFeed: getQuoteFeed(
          sessionStorage.getItem('exchange'),
          parseInt(sessionStorage.getItem('instrument_token'))
        ),
    ...
    menuPeriodicity: [
      ...
      { type: "item", label: "2 Min", cmd: "Layout.setPeriodicity(2,1,'minute')" },
      { type: "item", label: "3 Min", cmd: "Layout.setPeriodicity(3,1,'minute')" },
      { type: "item", label: "4 Min", cmd: "Layout.setPeriodicity(2,2,'minute')" },
      { type: "item", label: "5 Min", cmd: "Layout.setPeriodicity(5,1,'minute')" },
      // { type: "item", label: "1 Min", cmd: "Layout.setPeriodicity(0.5,2,'minute')" },
      // { type: "item", label: "2 Min", cmd: "Layout.setPeriodicity(1,2,'minute')" },
      // { type: "item", label: "3 Min", cmd: "Layout.setPeriodicity(1.5,2,'minute')" },
      // { type: "item", label: "4 Min", cmd: "Layout.setPeriodicity(2,2,'minute')" },
      // { type: "item", label: "5 Min", cmd: "Layout.setPeriodicity(2.5,2,'minute')" },
      { type: "item", label: "10 Min", cmd: "Layout.setPeriodicity(2,5,'minute')" },
      { type: "item", label: "15 Min", cmd: "Layout.setPeriodicity(3,5,'minute')" },
      { type: "item", label: "30 Min", cmd: "Layout.setPeriodicity(2,15,'minute')" },
      { type: "item", label: "1 Hour", cmd: "Layout.setPeriodicity(1,60,'minute')" },
